                        ...
                        <table className="w-full text-left">
                            <thead>
                                <tr className="bg-gray-50/50 text-[10px] uppercase font-bold text-slate-400 tracking-wider border-b border-gray-100">
                                    <th className="hidden sm:table-cell px-6 py-4 w-12"><input type="checkbox" className="rounded text-primary focus:ring-primary cursor-pointer" /></th>
                                    <th className="px-4 md:px-6 py-4">Veículo</th>
                                    <th className="hidden md:table-cell px-6 py-4">Categoria</th>
                                    <th className="px-4 md:px-6 py-4">Status</th>
                                    <th className="hidden lg:table-cell px-6 py-4">Última Vistoria</th>
                                    <th className="hidden xl:table-cell px-6 py-4">Km Atual</th>
                            ...
                            <tbody className="divide-y divide-gray-100">
                                {VEHICLES.map((v) => (
                                    <tr key={v.id} className="hover:bg-gray-50 transition-colors group">
                                        <td className="hidden sm:table-cell px-6 py-4"><input type="checkbox" className="rounded text-primary focus:ring-primary cursor-pointer" /></td>
                                        <td className="px-4 md:px-6 py-4">
                                            <div className="flex items-center gap-4">
                                                <div className="w-12 h-12 rounded-lg bg-gray-100 flex items-center justify-center overflow-hidden border border-gray-100 relative shrink-0">
                                        ...
                                        <td className="hidden md:table-cell px-6 py-4 text-sm text-slate-600">{v.category}</td>
                                        <td className="px-4 md:px-6 py-4">
                                        ...
                                        <td className="hidden xl:table-cell px-6 py-4 text-sm font-mono text-slate-600">{v.km}</td>
