        ...
        <div className="flex flex-col h-full bg-[#f6f6f8]">
            ...
            <div className="p-4 md:p-8 space-y-6 max-w-[1400px] mx-auto w-full">
                <div className="flex gap-2 overflow-x-auto pb-2 scrollbar-hide">
                    <button className="px-4 py-2 bg-white border border-gray-200 rounded-lg text-sm font-bold text-primary shadow-sm hover:bg-red-50 transition-colors">Todos (45)</button>
                        ...
                        <table className="w-full text-left">
                            <thead>
                                <tr className="bg-gray-50/50 text-[10px] uppercase font-bold text-slate-400 tracking-wider border-b border-gray-100">
                                    ...
                                    <th className="px-4 md:px-6 py-4">Função</th>
                                    <th className="hidden sm:table-cell px-6 py-4 text-center">Status</th>
                                    <th className="hidden lg:table-cell px-6 py-4">Última Atividade</th>
                            ...
                            <tbody className="divide-y divide-gray-100">
                                {users.map((u) => (
                                    <tr key={u.id} className="hover:bg-gray-50 transition-colors group">
                                        ...
                                        <td className="hidden lg:table-cell px-6 py-4 text-sm text-slate-500">{u.lastActive}</td>
