    ...
    return (
        <div className="flex flex-col h-full bg-[#f6f6f8]">
            ...
            <header className="hidden md:flex h-16 px-8 items-center justify-between bg-white border-b border-gray-200 sticky top-0 z-10">
                <div>
                    <h2 className="text-lg font-bold text-slate-900">Gestão de Cobranças</h2>
                    <p className="text-xs text-slate-500 mt-0.5">Controle financeiro e emissão de boletos</p>
                </div>
            </header>
            ...
            <div className="p-4 md:p-8 space-y-8 max-w-[1400px] mx-auto w-full">
                <div className="bg-white rounded-2xl border border-gray-200 p-6 shadow-sm">
                    ...
                    {/* ... form fields remain responsive by grid default ... */}
                    <form className="grid grid-cols-1 md:grid-cols-12 gap-6 items-end">
                        ...
                        <div className="md:col-span-6">
                            ...
                            <div className="relative">
                                ...
                                <input className="w-full pl-10 pr-4 py-2.5 bg-gray-50 border border-gray-200 rounded-full text-sm outline-none focus:ring-1 focus:ring-primary" placeholder="Buscar motorista..." />
                            </div>
                        </div>
                        {/* ... */}
                        <div className="md:col-span-3">
                            <label className="text-xs font-bold uppercase text-slate-400 mb-2 block">Valor (R$)</label>
                            <input className="w-full px-4 py-2.5 bg-gray-50 border border-gray-200 rounded-full text-sm outline-none focus:ring-1 focus:ring-primary" placeholder="0,00" />
                        </div>
                        <div className="md:col-span-3">
                            <label className="text-xs font-bold uppercase text-slate-400 mb-2 block">Vencimento</label>
                            <input type="date" className="w-full px-4 py-2.5 bg-gray-50 border border-gray-200 rounded-full text-sm outline-none focus:ring-1 focus:ring-primary" />
                        </div>
                        <div className="md:col-span-8">
                            <label className="text-xs font-bold uppercase text-slate-400 mb-2 block">Código de Barras</label>
                            <textarea rows={3} className="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-2xl text-sm font-mono outline-none focus:ring-1 focus:ring-primary" placeholder="Linha digitável..." />
                        </div>
                        ...
                        <div className="md:col-span-12 flex justify-end">
                            <button className="bg-primary text-white font-bold px-8 py-2.5 rounded-full shadow-lg shadow-red-900/20 hover:bg-primary-hover transition-all w-full md:w-auto">Salvar Cobrança</button>
                        </div>
                    </form>
                </div>
                ...
                <div className="bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden">
                    <div className="p-6 border-b border-gray-100 flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                        ...
                        <div className="flex gap-2 w-full md:w-auto">
                            <button className="flex-1 md:flex-none px-3 py-1.5 text-xs font-bold border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors">Filtrar</button>
                            <button className="flex-1 md:flex-none px-3 py-1.5 text-xs font-bold border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors">Exportar</button>
                        </div>
                    </div>
                        ...
                        <table className="w-full text-left text-sm">
                            <thead className="bg-gray-50 text-[10px] uppercase font-bold text-slate-400 tracking-wider">
                                <tr>
                                    ...
                                    <th className="hidden sm:table-cell px-6 py-4">Vencimento</th>
                            ...
                            <tbody className="divide-y divide-gray-100">
                                {[
                                    ...
                                    <tr key={i} className="hover:bg-gray-50 transition-colors group">
                                        ...
                                        <td className="hidden sm:table-cell px-6 py-4 text-slate-500">{c.date}</td>
                                        <td className="px-4 md:px-6 py-4 font-bold text-slate-900">{c.val}</td>
