...
const BillingManagement: React.FC<BillingManagementProps> = ({ onNavigate }) => {
  return (
        ...
        <div className="bg-white rounded-2xl border border-gray-200 p-6 shadow-sm">
          ...
          <form className="grid grid-cols-1 md:grid-cols-12 gap-6 items-end">
            ...
            <div className="md:col-span-4 h-full flex flex-col justify-end">
              ...
              <div className="flex-1 min-h-[96px] border-2 border-dashed border-gray-200 rounded-2xl flex flex-col items-center justify-center bg-gray-50 cursor-pointer hover:bg-red-50 transition-colors">
            ...
            <div className="md:col-span-12 flex justify-end">
              <button className="w-full md:w-auto bg-primary text-white font-bold px-8 py-2.5 rounded-full shadow-lg shadow-red-900/20 hover:bg-primary-hover">Salvar Cobrança</button>
            </div>
          </form>
        </div>
        ...
        <div className="bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden">
          <div className="p-6 border-b border-gray-100 flex justify-between items-center">
            ...
            <div className="flex gap-2">
              <button className="px-3 py-1.5 text-xs font-bold border border-gray-200 rounded-lg hover:bg-gray-50">Filtrar</button>
              <button className="px-3 py-1.5 text-xs font-bold border border-gray-200 rounded-lg hover:bg-gray-50">Exportar</button>
            </div>
          </div>
            ...
            <table className="w-full text-left text-sm">
              <thead className="bg-gray-50 text-[10px] uppercase font-bold text-slate-400 tracking-wider">
                <tr>
                  ...
                  <th className="px-4 md:px-6 py-4 hidden sm:table-cell">Vencimento</th>
              ...
              <tbody className="divide-y divide-gray-100">
                {[
                  ...
                  <tr key={i} className="hover:bg-gray-50 transition-colors group">
                    ...
                    <td className="px-4 md:px-6 py-4 text-slate-500 hidden sm:table-cell">{c.date}</td>
                    ...
                    <td className="px-4 md:px-6 py-4 text-right">
                      <button className="text-slate-300 hover:text-primary"><span className="material-symbols-outlined">more_vert</span></button>
                    </td>
                  </tr>
                ))}
              </tbody>
