    ...
    <div className="bg-[#e0e2e5] min-h-screen flex items-center justify-center py-8 font-sans">
      <div className="relative w-full max-w-[375px] h-[812px] bg-[#f8f9fa] rounded-[2.5rem] shadow-2xl overflow-hidden flex flex-col border-[8px] border-white box-content">
        ...
        <div className="flex-1 flex flex-col overflow-y-auto hide-scrollbar pb-20">
          <header className="flex items-center justify-between px-6 pt-2 pb-6">
            <div className="flex items-center gap-3">
              <div className="w-11 h-11 rounded-full bg-gray-200 bg-center bg-cover border-2 border-white shadow-md" style={{ backgroundImage: `url('https://picsum.photos/seed/rafael/100/100')` }}></div>
              <div>
          ...
          <div className="px-5 mb-6">
            <div className="bg-white rounded-3xl p-5 border border-gray-100 shadow-sm">
              ...
              <div className="relative w-full aspect-[16/10] rounded-2xl overflow-hidden mb-5 bg-gray-100">
                <img src="https://lh3.googleusercontent.com/aida-public/AB6AXuAohq6ph4p5RtGirRkg1Qs2Ig7A3prnWoVSh77f4GNAJhw_xvSYhb6Npdey2UuqBIWr4LWoHx7___s3NMacBDx_-XsNNggsbFdZeYMARlR3eVoeHDTSDtSBIlra8NqKhHd5otRjyJHm2d8jpFcmIqJwUawB9c7fnTX6DTeKkhAm212e7olicSfz8oM_f65T0-vvPIypsqwg7ss7wz51aOcHKCmZo_KJdJ2emJc4hSrWV5_TgMuVrfww99XotnCPxfj8I4xG0CN0b4k" className="w-full h-full object-contain" alt="Car" />
              </div>
          ...
          <div className="px-5 mb-6">
            <div className="bg-red-50 border border-red-100 rounded-3xl p-6 relative overflow-hidden group">
              ...
              <div className="relative z-10">
                ...
                <button onClick={() => onNavigate('INSPECTION')} className="w-full bg-[#A32A2A] text-white font-bold py-3.5 px-4 rounded-xl shadow-lg flex items-center justify-center gap-2.5 active:scale-95 transition-transform">
          ...
          <div className="px-5 mb-6">
            ...
            <div className="grid grid-cols-2 gap-4">
              <button className="flex flex-col items-start gap-3 p-4 bg-white rounded-2xl border border-gray-100 shadow-sm text-left">
              ...
              <button onClick={() => onNavigate('BILLING')} className="flex flex-col items-start gap-3 p-4 bg-white rounded-2xl border border-gray-100 shadow-sm text-left">
        ...
        <nav className="absolute bottom-0 w-full bg-white border-t border-gray-100 pb-6 pt-3 px-6 flex justify-between items-end z-30 rounded-t-[20px] shadow-[0_-5px_20px_rgba(0,0,0,0.03)]">
          <button onClick={() => onNavigate('CLIENT_DASHBOARD')} className="flex flex-col items-center gap-1.5 text-primary w-12">
            <span className="material-symbols-outlined icon-filled">home</span>
            <span className="text-[10px] font-bold">Início</span>
          </button>
          <button onClick={() => onNavigate('CATALOG')} className="flex flex-col items-center gap-1.5 text-gray-400 w-12">
            <span className="material-symbols-outlined">directions_car</span>
            <span className="text-[10px] font-medium">Catálogo</span>
          </button>
          <button onClick={() => onNavigate('BILLING')} className="flex flex-col items-center gap-1.5 text-gray-400 w-12">
            <span className="material-symbols-outlined">account_balance_wallet</span>
            <span className="text-[10px] font-medium">Finanças</span>
          </button>
          <button onClick={() => onNavigate('LANDING')} className="flex flex-col items-center gap-1.5 text-gray-400 w-12">
